...
plt <- ggplot(dfplt) + 
  ...
  geom_line(aes(levels_begin,density,color="density"),size=2) +
  geom_line(aes(levels_begin,density*(1-censrate),color="density*(1-censoring rate)"),size=2) +
  geom_smooth(aes(levels_begin,censrate,color="censoring rate"),span=0.2,level=0,size=2) +
  geom_point(aes(levels_begin,censrate,color="censoring rate"),size=2) +
